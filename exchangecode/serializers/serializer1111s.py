...
from exchangecode.models import Teacher,Area,School,Batch,Code
...
class CreateBatchSerializer(ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        for code in code_file:
            ...
            code_info={"code_name":code,"batch":batch_info,"school_id":None,"status":Code.status_emun.FREE.value}
